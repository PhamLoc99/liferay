package police_force_activities.portlet;

import police_force_activities.constants.Police_force_activitiesPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Police_force_activities",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/view.jsp",
		"javax.portlet.name=" + Police_force_activitiesPortletKeys.POLICE_FORCE_ACTIVITIES,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class Police_force_activitiesPortlet extends MVCPortlet {
	@Override
	public void doView(RenderRequest renderRequest, RenderResponse renderResponse)
			throws IOException, PortletException {

		try {
			AssetCategory assetCategory = AssetCategoryLocalServiceUtil.getAssetCategory(113410);
